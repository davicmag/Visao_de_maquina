...
img = cv2.imread("Visao_de_maquina/Projeto intermediario/Dataset_Projeto1/_Pinheiro_Escolhidos1/Pinheiro1.jpg")
if img is None:
...
mascara_caule = cv2.dilate(mask_caule, kernel, iterations=3)
